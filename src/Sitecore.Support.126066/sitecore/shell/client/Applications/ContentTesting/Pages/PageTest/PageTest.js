define([
  ...
  var PageTest = _sc.Definitions.App.extend({
    ...
    selectTestPage: function (itemParams) {
	  ...
	  //126066
	  if (!(itemParams.id||itemParams.la)){
		var tmp = itemParams.substr(itemParams.lastIndexOf('lang=')+5);
		var tmpLang = tmp.substr(0,tmp.indexOf('&'));
		itemParams = {id : itemParams.substr(itemParams.lastIndexOf('/')+1,38), la : tmpLang};
